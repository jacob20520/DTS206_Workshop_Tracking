...
| **Art 3:** DB access not from web tier | **Phase 2: Containment** | DPO | **IMMEDIATE** | **Art. 32(1)(a) / Art. 33 - Confidentiality:** Indicates a severe architectural bypass. Potential active data exfiltration triggering immediate DPO assessment for data breach reporting. |
